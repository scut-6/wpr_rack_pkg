...
{
    ros::init(argc, argv, "wpb_home_rack_node");
    ROS_INFO("wpb_home_rack_node start!");
    ...
    ros::Subscriber grab_res_sub = n.subscribe("/wpb_home/grab_result", 30, GrabResultCB);
    place_pub = n.advertise<geometry_msgs::Pose>("/wpb_home/place_action", 1);
    ros::Subscriber place_res_sub = n.subscribe("/wpb_home/place_result", 30, PlaceResultCB);
    ...
    odom_ctrl_pub = n.advertise<std_msgs::String>("/wpb_home/ctrl", 10);
